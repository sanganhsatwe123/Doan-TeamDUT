	...
	<div id="myCarousel" class="carousel slide">
		<div class="carousel-inner">
			<div class="item active">
				<div class="container">
					<a href="register.html"><img style="width: 100%"
						src="template/web/themes/images/carousel/1.png"
			...
			<div class="item">
				<div class="container">
					<a href="register.html"><img
						src="template/web/themes/images/carousel/3.png" alt="" /></a>
					<div class="carousel-caption">
						<h4>Second Thumbnail label</h4>
						<p>Cras justo odio, dapibus ac facilisis in, egestas eget
							quam. Donec id elit non mi porta gravida at eget metus. Nullam id
			...
			<div class="item">
				<div class="container">
					<a href="register.html"><img
						src="template/web/themes/images/carousel/4.png" alt="" /></a>
					<div class="carousel-caption">
						<h4>Second Thumbnail label</h4>
						<p>Cras justo odio, dapibus ac facilisis in, egestas eget
							quam. Donec id elit non mi porta gravida at eget metus. Nullam id
			...
			<div class="item">
				<div class="container">
					<a href="register.html"><img
						src="template/web/themes/images/carousel/5.png" alt="" /></a>
					<div class="carousel-caption">
						<h4>Second Thumbnail label</h4>
						<p>Cras justo odio, dapibus ac facilisis in, egestas eget
							quam. Donec id elit non mi porta gravida at eget metus. Nullam id
			...
			<div class="item">
				<div class="container">
					<a href="register.html"><img
						src="template/web/themes/images/carousel/6.png" alt="" /></a>
					<div class="carousel-caption">
						<h4>Second Thumbnail label</h4>
						<p>Cras justo odio, dapibus ac facilisis in, egestas eget
							quam. Donec id elit non mi porta gravida at eget metus. Nullam id
								...
								<div class="item active">
									<ul class="thumbnails">
										<li class="span3">
											<div class="thumbnail">
												<i class="tag"></i> <a href="product_details.html"><img
													src="template/web/themes/images/products/b1.jpg" alt="" /></a>
												<div class="caption">
													<h5>Product name</h5>
													<h4>
										...
										<li class="span3">
											<div class="thumbnail">
												<i class="tag"></i> <a href="product_details.html"><img
													src="template/web/themes/images/products/b2.jpg" alt="" /></a>
												<div class="caption">
													<h5>Product name</h5>
													<h4>
														<a class="btn" href="product_details.html">VIEW</a> <span
										...
										<li class="span3">
											<div class="thumbnail">
												<i class="tag"></i> <a href="product_details.html"><img
													src="template/web/themes/images/products/b3.jpg" alt="" /></a>
												<div class="caption">
													<h5>Product name</h5>
													<h4>
														<a class="btn" href="product_details.html">VIEW</a> <span
										...
										<li class="span3">
											<div class="thumbnail">
												<i class="tag"></i> <a href="product_details.html"><img
													src="template/web/themes/images/products/b4.jpg" alt="" /></a>
												<div class="caption">
													<h5>Product name</h5>
													<h4>
														<a class="btn" href="product_details.html">VIEW</a> <span
								...
								<div class="item">
									<ul class="thumbnails">
										<li class="span3">
											<div class="thumbnail">
												<i class="tag"></i> <a href="product_details.html"><img
													src="template/web/themes/images/products/5.jpg" alt="" /></a>
												<div class="caption">
													<h5>Product name</h5>
													<h4>
														<a class="btn" href="product_details.html">VIEW</a> <span
								...
								<div class="item">
									<ul class="thumbnails">
										...
										<li class="span3">
											<div class="thumbnail">
												<a href="product_details.html"><img
													src="template/web/themes/images/products/1.jpg" alt="" /></a>
												<div class="caption">
													<h5>Product name</h5>
													<h4>
														<a class="btn" href="product_details.html">VIEW</a> <span
								...
								<div class="item">
									<ul class="thumbnails">
										<li class="span3">
											<div class="thumbnail">
												<a href="product_details.html"><img
													src="template/web/themes/images/products/2.jpg" alt="" /></a>
												<div class="caption">
													<h5>Product name</h5>
													<h4>
														<a class="btn" href="product_details.html">VIEW</a> <span
										...
										<li class="span3">
											<div class="thumbnail">
												<a href="product_details.html"><img
													src="template/web/themes/images/products/3.jpg" alt="" /></a>
												<div class="caption">
													<h5>Product name</h5>
													<h4>
														<a class="btn" href="product_details.html">VIEW</a> <span
										...
										<li class="span3">
											<div class="thumbnail">
												<a href="product_details.html"><img
													src="template/web/themes/images/products/4.jpg" alt="" /></a>
												<div class="caption">
													<h5>Product name</h5>
													<h4>
														<a class="btn" href="product_details.html">VIEW</a> <span
