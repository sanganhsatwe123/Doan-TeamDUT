						...
						<div class="form-box">
							<div class="form-content">
								...
								<form action="/spring-mvc/addproduct" name="addProduct" method="POST"
									...
									<div>
										<label for="file2">File:</label> <input type="file" id="file" name="file2"
											onchange="previewImage2(event)"> <img id="preview2" src="#"
											alt="Preview Image"
											style="display: none; max-width: 200px; max-height: 200px;">
										<c:if test="${not empty message}">
											<div class="alert alert-danger">${message}</div>
									...
									<div class="form-group">
										<label for="file3" class="form-label">File:</label>
										<input class="form-control" type="file" id="file" name="file3"
