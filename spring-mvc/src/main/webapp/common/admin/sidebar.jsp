...
<ul class="sidebar navbar-nav">
    ...
    <li class="nav-item"><a class="nav-link" href="/spring-mvc/quanlyuser">
        ...
        <li class="nav-item"><a class="nav-link" href="/spring-mvc/quanlykhachhang">
            <i class="fas fa-fw fa-table"></i> <span>Customer management</span>
    </a></li>
    <li class="nav-item"><a class="nav-link" href="/spring-mvc/quanlyproduct">
        ...
        <li class="nav-item"><a class="nav-link" href="/spring-mvc/quanlyhoadon">
