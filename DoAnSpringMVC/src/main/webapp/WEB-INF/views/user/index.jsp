			...
			<div class="well well-small">
				<ul class="nav nav-list">
					<li><a href="products.html"><span
							class="icon-chevron-right"></span>Áo thể thao</a></li>
					<li><a href="products.html"><span
							class="icon-chevron-right"></span>Giày thể thao</a></li>
					<li><a href="products.html"><span
							class="icon-chevron-right"></span>Dụng cụ thể thao</a></li>
					<li><a href="products.html"><span
							class="icon-chevron-right"></span>Máy chạy bộ</a></li>
					<li><a href="products.html"><span
							class="icon-chevron-right"></span>Bong1a các loại</a></li>
					<li><a href="products.html"><span
							class="icon-chevron-right"></span>Sport Bra</a></li>
					<li><a href="products.html"><span
							class="icon-chevron-right"></span>Protein</a></li>
					<li><a href="products.html"><span
							class="icon-chevron-right"></span>Nước uống thể thao</a></li>
					<li><a href="products.html"><span
							class="icon-chevron-right"></span>Something is here</a></li>
					<li><a href="products.html"><span
							class="icon-chevron-right"></span>Ở sẽ là một cái gì đó</a></li>
